...
import numpy as np
import colorsys
from src.src.MNViz_colors import * #cores_familia_crustacea, cores_familia_reptiles, cores_ordem, cores_infraordem, cores_ordem_polychaete, cores_familia_polychaete
